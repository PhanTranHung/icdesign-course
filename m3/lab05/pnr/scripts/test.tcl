...
create_pg_mesh_pattern TOP_MESH_HORIZONTAL \
	-layers " \
		{ {horizontal_layer: M5}   {width: 0.3} {spacing: interleaving} {pitch: 4} {offset: 0.5}  {trim : true} } \
		" 
...
compile_pg -strategies {VDDVSS_TOP_MESH_VERTICAL VDDVSS_TOP_MESH_HORIZONTAL} -ignore_via_drc
