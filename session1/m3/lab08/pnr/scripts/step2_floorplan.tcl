...
################################################################################Save_Block
save_block -as 02_floorplan_init
...
initialize_floorplan -core_offset {500.0} -shape Rect -orientation N \
    -side_length {736.011 736.011} -control_type core
...
# report_placement
# ################################################################################Save_Block
save_block -as 02_${DESIGN_NAME}_floorplan_initialized
# ################################################################################Save_Block
