...
create_cell {VDDL0 VDDL1 VDDL2 VDDL3 VDDR0 VDDR1 VDDR2} -reference {VDD_EW}
create_cell {VSSL0 VSSL1 VSSL2 VSSL3 VSSR0 VSSR1 VSSR2} -reference {VSS_EW}

create_cell {IOVDDL0 IOVDDL1 IOVDDR0 IOVDDR1} -reference {IOVDD_EW}
create_cell {IOVSSL0 IOVSSL1 IOVSSR0 IOVSSR1} -reference {IOVSS_EW}
